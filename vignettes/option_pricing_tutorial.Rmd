...
This vignette explains how to use the `optionsLibrary` package to price European options using Black-Scholes, binomial pricing, and Monte Carlo simulation and includes a simple application.\
